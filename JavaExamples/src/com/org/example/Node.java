...
class LinkedList2 {
	...
	public LinkedList2 find(String data) {
		LinkedList2 temp = this.head;
	...
	public void insert(String data, String dataBefore) {
		...
		if (this.head == null)
			...
			LinkedList2 nodeBefore = this.find(dataBefore);
			if (nodeBefore != null) {
	...
	public void delete(String data) {
		...
		if (this.head == null)
			...
			LinkedList2 node = this.find(data);
